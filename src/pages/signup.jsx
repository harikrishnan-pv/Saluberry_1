            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="appearance-none rounded-none relative block my-2 w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              >
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <LockClosedIcon
                    className="h-5 w-5 text-pink-400 group-hover:text-pink-400"
                    aria-hidden="true"
                  />
                </span>
                Sign Up
